...
type setUserPhotoSuccessActionType = { type: typeof SET_USER_PHOTO_SUCCESS, photos: any}
...
export const setUserPhotoSuccess = (photos: any): setUserPhotoSuccessActionType => ({ type: SET_USER_PHOTO_SUCCESS, photos });
